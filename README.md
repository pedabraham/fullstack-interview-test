# Installation
## Front
To use the Front go to the /git-ui folder and run:
- npm install
- npm start
## Backend
...
- uvicorn git_api.main:app --reload

if you want to see how the api is composed go to  [http://127.0.0.1:8000/docs](http://127.0.0.1:8000/docs)

Now to use the whole app go to
